package com.bulgogi.flag.view.renderer;
...
public class Flag {
    ...
    private static final float hPercent = 1.0f; // Height of the texture as a percentage of the bitmap
    ...
    public void drawFrame(GL10 gl, int surfaceWidth, int surfaceHeight) {
        ...
        gl.glClearColor(0.945f, 0.933f, 0.937f, 1f);               //This Will Clear The Background Color To Black
...
//////////////////		
        ...
        if (yrot > 180f + 30f) addX = false;
        if (yrot > 180f - 30f) addX = true;
        if (yrot > 20f) addY = false;
        if (yrot < -20f) addY = true;
    ...
    public void initialize(GL10 gl, int surfaceWidth, int surfaceHeight) {
        ...
        GLU.gluPerspective(gl, 45.0f, 1.0f, 0.1f, 100.0f);  // Calculate The Aspect Ratio Of The Window
